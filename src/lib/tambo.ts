...
import { ExecutionLog, executionLogSchema } from "@/components/flow/execution-log";
import { z } from "zod";
...
export const tools: TamboTool[] = [
  {
    ...
    description: "Helper tool to analyze a workflow request. Use this before rendering the FlowCanvas if complex reasoning is needed.",
...
export const components: TamboComponent[] = [
  ...
  {
    name: "ExecutionLog",
    description: "Shows the output of a workflow run. Render this after executing a workflow to display execution logs and status.",
    component: ExecutionLog,
    propsSchema: executionLogSchema,
  }
];
